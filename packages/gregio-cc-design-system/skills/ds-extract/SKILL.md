...
site para um cache local reutilizável em `.ds-cache/<site-slug>/`.
...
- Se o cache já existe completo, o crawler reporta `cached: true` e não toca na rede —
  só use `--force` se o usuário pedir dados frescos.
