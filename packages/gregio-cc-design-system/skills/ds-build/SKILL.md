...
argument-hint: <cache-dir> <app-dir> [--react]
---
...
Resumo do contrato:
- Pré-requisitos: `analysis/consolidated.json` + `gaps.md` + `ds-spec.md`
  aprovado no cache (senão aponte a fase faltante: `/ds-analyze` ou `/ds-brainstorm`).
