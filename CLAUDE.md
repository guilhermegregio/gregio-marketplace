...
| `gregio-cc-harness` | [packages/gregio-cc-harness/CLAUDE.md](packages/gregio-cc-harness/CLAUDE.md) | Doc e contratos do bootstrap do harness — implementação em `cli/kb` (`kb doctor`, `kb status`, `kb map`, `kb rules`, `kb guard`) |
